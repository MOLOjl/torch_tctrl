...
from .transformer import LogTimeStamp, ParallelTransformer
    ...
    def forward(self, enc_input_ids, enc_position_ids, enc_attn_mask,
        ...
        if self.pre_process:
            if self.profile_recompute:
                enc_input_ids = LogTimeStamp.apply(enc_input_ids, "before embedding")
            encoder_input = self.embedding(enc_input_ids, enc_position_ids,
                                           tokentype_ids=tokentype_ids)
            if self.profile_recompute:
                encoder_input = LogTimeStamp.apply(encoder_input, "after embedding")
        else:
            encoder_input = None
