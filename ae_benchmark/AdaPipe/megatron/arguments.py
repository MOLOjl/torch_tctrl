...
def _add_logging_args(parser):
    ...
    group.add_argument('--log-dir', type=str, default="log",
                       help='lod directory')
...
def _add_training_args(parser):
    ...
    group.add_argument('--profile-recompute', action='store_true',
                       help='profile time for operators')
    group.add_argument('--profile-memory', action='store_true',
                       help='profile memory for operators')
    group.add_argument('--debug-correctness', action='store_true',
                       help='print the tensor content')
...
def _add_distributed_args(parser):
    ...
    group.add_argument('--recompute-config', type=str, default=None,
                       help='recomputation strategy configuration.')
